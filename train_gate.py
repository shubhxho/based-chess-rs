...
def main():
    ...
    if not args.skip_train:
        ...
        env.setdefault("EVAL_W", "0.9")
        env.setdefault("LR", "3e-3")
        env.setdefault("BATCH", "16384")
        env.setdefault("PATIENCE", "10")
        env.setdefault("MIN_EPOCHS", "20")
        env.setdefault("EVAL_EVERY", "1")
        env.setdefault("LR_FLOOR", "0.08")
        env.setdefault("WARMUP", "2")
